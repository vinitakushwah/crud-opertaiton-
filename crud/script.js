...
function getdata() {
    ...
    fetch("https://stage.webtalkx.com/api/I2BRecordingRequest/GetRecordingRequestQuestions", {
...
form.addEventListener('submit', (event) => {
    ...
    var url = "https://stage.webtalkx.com/api/I2BRecordingRequest/InsertRecordingQuestions";
    ...
    for (let i = 0; i < btn_len; i++) {
        ...
        if (edit_btn[i]) {
            ...
            //   console.log(objectdata[i])
                    ...
                    updateindex = objectdata[i];
       
                //   console.log("hello mkffk");
